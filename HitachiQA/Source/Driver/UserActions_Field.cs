...
namespace HitachiQA.Driver
{
    public partial class UserActions
    {
        public string GetFieldValue(By[] by)
        {
            ...
            fieldDoc.LoadHtml(fieldElement.GetDomAttribute("outerHTML"));
            ...
            try
            {
                ...
                switch (matchingPair.Value)
                {
                    ...
                    case "switch":
                        ...
                        if (bool.Parse(element.GetDomAttribute("aria-checked")) != switchVal)
                            element.Click();
                        break;
                    case "lookup_with_table":
                        this.setText(autoGeneratedLocator, value);
                    ...
                    case "bh-question-singleselect":
                        ...
                        var clicked = radio_Retry.Execute(() =>
                        {
                            ...
                            return FindElementWaitUntilPresent(radio_Locator).GetDomAttribute("class").Contains("radio-checked");
                        });
